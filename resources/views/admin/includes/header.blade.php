<nav
    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
           ...
           '            <h3 class="brand-text">Aya's dashboard</h3>
                    </a>
                </li>
                ...
                <span class="mr-1">@lang('messages.Hello')
                  <span
                      ...
                      @elseif (auth()->guard('providers')->check() && auth()->guard('providers')->user()->hasRole('providers'))
                        {{ auth()->guard('providers')->user()->name}}
                      @endif
                  </span>
                </span>
                        ...
                        @elseif (auth()->guard('providers')->check() && auth()->guard('providers')->user()->hasRole('providers'))
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href=""><i class="ft-user"></i>
                                    @lang('providers.edit-profile')
                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ route('providers.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                    <i class="ft-power"></i>
                                    @lang('messages.logout')
                                </a>
                                <form id="logout-form" action="{{ route('providers.logout') }}" method="POST"> <!-- Use the correct route for providers' logout -->
                                    @csrf
                                </form>
                            </div>
                        @endif
...
<!--                          <img src="{{asset('admin-assets/images/portrait/small/avatar-s-6.png')}}" alt="avatar">-->
    <i></i></span>
                                        </div>
                                        <div class="media-body">
