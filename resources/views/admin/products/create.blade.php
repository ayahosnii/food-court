                                        ...
                                        <form class="form" action="{{route('admin.meals.store')}}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            <label for="projectinput1">اختر المطعم</label>
                                                            <select type="text" id="provider_id"
                                                                   class="form-control"
                                                                   name="provider_id">
                                                                <optgroup label="من فضلك المطعم ">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" value="" id="name_{{ $lang->abbr }}" class="form-control" placeholder="" name="name_{{ $lang->abbr }}">
                                                                    @error("name_{{ $lang->abbr }}")
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            </div>
                                                            <!-- Add similar fields for other languages -->
                                                        </div>
