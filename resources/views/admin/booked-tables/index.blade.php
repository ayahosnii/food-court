                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <h1 class="mx-5">Booked Tables for {{ date('F Y') }}</h1>
                                            ...
                                            @isset($reservations)
                                                @foreach($reservations as $reservation)
                                                    <tr>
                                                        ...
                                                        <td>{{$reservation -> booked_price}} LE</td>
                                                        <td>{{$reservation -> res_date}} </td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                 aria-label="Basic example">
                                                                <a href="{{route('admin.attributes.edit',$reservation -> id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">تعديل</a>


                                                                <a href="{{route('admin.attributes.delete',$reservation -> id)}}"
