                                                                ...
                                                                <td>
                                                                    <div class="order-status form-control" data-id="{{$order->id}}" data-status="{{$order->status}}">
                                                                        <select>
                                                                            ...
                                                                            <option value="ordered" {{ $order->status == 'ordered' ? 'selected' : '' }}>Pended</option>
                                                                            <option value="canceled" {{ $order->status == 'canceled' ? 'selected' : '' }}>Cancel</option>
                                                                        </select>
                                                                    </div>
                                                                </td>
                                                            <td>
                                                                <a href="{{ route('admin.orders.confirm.account', $order->id) }}" class="btn btn-success">Confirm accounts</a>
                                                            </td>
                                                        </tr>
