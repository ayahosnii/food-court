<div>
    @livewire('all-courts')
    @livewire('hero-section', ['title' => 'Privacy Policy', 'pageName' => 'Privacy Policy'])

    <section class="checkout spad">
        <div class="container">
            <div class="checkout__form">
                <h4>Privacy Policy <li class="fa fa-user"></li></h4>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Food Court, 1 El-Hefnawi St., Pyramids.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Food Court, accessible from <a href="http://food-court.ayahosni.com/" rel="external nofollow noopener" target="_blank">http://food-court.ayahosni.com/</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: food-court@site.com</li>
                </ul>
            </div>
        </div>
    </section>
